 ...
 ******************************************************************************
 Database settings
 ******************************************************************************/
$SI_db['server']	= "sql.pmroczko.nazwa.pl";	// leave as localhost unless you know otherwise
$SI_db['username']	= "pmroczko_1";	// The username used to acces your database
$SI_db['password']	= "DeltA9999";	// The password used to acces your database
$SI_db['database']	= "pmroczko_1";	// The database where you would like to store the stats table
 ...
 ******************************************************************************/
$SI_display['sitename']		= "Vietnam War Virtual Museum";	// The full name of the site
$SI_display['siteshort']	= "Vietnam War";			// Used to indicate hits to the homepage
